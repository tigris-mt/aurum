...
## Getting Aurum
The [latest stable version](https://github.com/tigris-mt/aurum-compiled/archive/stable.zip) of Aurum is 0.55.2.4, developed for Minetest 5.3.0 and later.

* Direct download: [Stable 0.55.2.4](https://github.com/tigris-mt/aurum-compiled/archive/stable.zip)
