...
# Getting Aurum
The [latest stable version](https://github.com/tigris-mt/aurum-compiled/archive/stable.zip) of Aurum is 0.45.5, developed for Minetest 5.2.0 and later.

* Direct download: [Stable 0.45.5](https://github.com/tigris-mt/aurum-compiled/archive/stable.zip)
