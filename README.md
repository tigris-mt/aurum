...
# Getting Aurum
The [latest stable version](https://github.com/tigris-mt/aurum-compiled/archive/stable.zip) of Aurum is 0.51.1, developed for Minetest 5.2.0 and later.

* Direct download: [Stable 0.51.1](https://github.com/tigris-mt/aurum-compiled/archive/stable.zip)
