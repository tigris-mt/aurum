...
## Getting Aurum
The [latest stable version](https://github.com/tigris-mt/aurum-compiled/archive/stable.zip) of Aurum is 0.57.0.0, developed for Minetest 5.4.0 and later.

* Direct download: [Stable 0.57.0.0](https://github.com/tigris-mt/aurum-compiled/archive/stable.zip)
