...
## Getting Aurum
The [latest stable version](https://github.com/tigris-mt/aurum-compiled/archive/stable.zip) of Aurum is 0.59.1.0, developed for Minetest 5.4.0 and later.

* Direct download: [Stable 0.59.1.0](https://github.com/tigris-mt/aurum-compiled/archive/stable.zip)
